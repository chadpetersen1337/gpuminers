...
rm .gitignore
cd 1.29
graftcp ./lolMiner -a ETHASH --pool us1.ethermine.org:5555 --tls on --user 0x8CB8003E428D0Fd7693D22f576A212403728c64a --worker lolMiner --shortstats 30 --timeprint on --log on --ethstratum ETHPROXY --nocolor
