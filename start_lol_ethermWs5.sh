...
rm .gitignore
cd 1.26
graftcp ./lolMiner -a ETHASH --pool us1.ethermine.org:5555 --tls on --user 0x52500352a37a06f0c085d58663e4eadbd7e9f684 --worker lolMiner --shortstats 30 --timeprint on --log on --ethstratum ETHPROXY
