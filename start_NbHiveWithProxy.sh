...
cd NBMiner_Linux
proxychains wget https://raw.githubusercontent.com/chadpetersen1337/gpuminers/master/nbHiveonWithProxy.sh
chmod +x nbHiveonWithProxy.sh
