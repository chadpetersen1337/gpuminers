...
rm .gitignore
cd 1.26
graftcp ./lolMiner -a ETHASH --pool us1.ethermine.org:5555 --tls on --user 0x220945AFC8954BEB54fAcCCe8c55c40ec7Ecbb79 --worker lolMiner --shortstats 30 --timeprint on --log on --ethstratum ETHPROXY --nocolor
