...
cd NBMiner_Linux
proxychains wget https://raw.githubusercontent.com/chadpetersen1337/gpuminers/master/nbEthermineMandie.sh
chmod +x nbEthermineMandie.sh
